...
const GRAPH_SIZE = { width: 350, height: 110 };
  ...
  useEffect(() => {
    ...
    state.value = {
      ...
      steps: [
        ...
        makeGraph(GRAPH_SIZE, steps.year),
      ],
    };
  }, [steps]);
  ...
  return (
    <View style={{ height: 250, width: "100%", gap: 10, marginTop: 50 }}>
      <ButtonGroup selectIndex={0}>
        ...
        <Button label={"Année"} onPress={() => onPress(2)} />
      </ButtonGroup>
      <View style={styles.container}>
        <View style={styles.steps}>
          <View style={{ paddingVertical: 0, flex: 1 }}>
            {["15 0000", "10 000", "5 000", "0"].map(
